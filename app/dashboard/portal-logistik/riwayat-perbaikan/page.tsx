...
function Page() {
  ...
  const [data, setData] = useState<PerbaikanData[]>([]);
  ...
  const [selectedItem, setSelectedItem] = useState<PerbaikanData | null>(null);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/logistik/riwayat-perbaikan?${params}`);
      const result = await response.json();
  ...
  const getFotos = (item: PerbaikanData) => {
    const fotos = [
      item.foto_1,
      item.foto_2,
      item.foto_3,
  ...
  const handleViewDetail = (item: PerbaikanData) => {
  ...
  return (
    <div className="@container mx-auto p-4">
      <header className="mb-6">
        ...
        <h1 className="text-3xl font-bold">Riwayat Perbaikan / Pengambilan Logistik</h1>
        <p className="text-gray-500 mt-2">
          Histori lengkap semua perbaikan dan pengambilan barang logistik
        </p>
        {isFiltered && (
        ...
        <CardContent className="p-0">
          {loading ? (
            ...
            <div className="text-center py-12 text-gray-500">
              ...
              <p>Tidak ada data riwayat perbaikan</p>
            </div>
          ) : (
            <>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-4xl max-h-[85vh] overflow-y-auto">
          <DialogHeader className="mt-6">
            <DialogTitle>Detail Perbaikan / Pengambilan Logistik</DialogTitle>
          </DialogHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-medium">
                    {formatDate(selectedItem.tanggal_perbaikan)}
                  </p>
                </div>
                ...
                <div className="space-y-1">
                  <p className="text-sm text-gray-500">Jumlah Diambil</p>
